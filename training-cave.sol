...
contract Trainning is SafeMath {
    ...
    uint256 constant public FEE = 1000000000000000000;
    ...
    function trainDragon(uint256 dragonId) external {
        require(balance[ownerOf[dragonId]] > FEE);
        require(FEE_ADDRESS.send(FEE));
        balance[ownerOf[dragonId]] = balance[ownerOf[dragonId]] - FEE;
